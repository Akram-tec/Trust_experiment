...
class C(BaseConstants):
    NAME_IN_URL = 'personality_baseline'
...
#page
class Instructions_baseline(Page):
    @staticmethod
...
page_sequence = [Instructions_baseline, TransitionPage, Send_baseline, SendWaitPage_baseline, SendBack_baseline, ResultsWaitPage, ResultsA_baseline,
                ]
