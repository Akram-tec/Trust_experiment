...
class Player(BasePlayer):
    ...
    gender = models.StringField(label='What is your gender?', choices=['Male', 'Female', 'Other', 'Prefer not to say'])
...
class Survey(Page):
    form_model = 'player'
    form_fields = ['q1', 'q2', 'q3', 'q4', 'q5', 'q6', 'q7', 'q8', 'q9', 'q10', 'gender', 'occupation']
